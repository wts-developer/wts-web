...
(function () {
  ...
  function runCalculator(root, app) {
    ...
    function selectProgram(key) {
      ...
      app.classList.remove("program-mats", "program-mac", "program-mdiv", "program-mar");
